...
server.on("request", (req,res)=>{
  ...
  if(url === '/list/'){
    ...
    fs.readFile('./addChapter.html','utf-8',(err,data)=>{
      if (err) return res.end("404");
      res.end(data)
    })
    
  }else if(url === '/detail?chapterId=1'||url === '/detail?chapterId=2'||url === '/detail?chapterId=3'
  ||url === '/detail?chapterId=4'){
    fs.readFile('./chapter',(err,data) => {
      if (err) return res.end("404");
      res.end(data)
    })
    res.writeHead(200, {
    ...
    var idname = document.getElementById('username');
    ...
    if(idname.value == userList.username&&password.value == userList.pwd){
      button.onclick = function() {window.location.href="addChapter.html";}
    }
  }
